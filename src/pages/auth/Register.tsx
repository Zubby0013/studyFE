...
const Register = () => {
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form className="space-y-6" action="#" method="POST">
      ...
      <div>
        ...
        <div className="mt-2">
          ...
          <label className="block text-sm font-medium leading-6 text-gray-900 mt-3">Comfirm Password</label>
          <input id="password" name="password" type="confirm password"  required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 "/>
        </div>
      </div>
    ...
    <p className="mt-10 text-center text-sm text-gray-500">
      A member?
      <Link to="/login">
      <div className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 cursor-pointer">Already have an account</div>
      </Link>
    </p>
  </div>
</div>
